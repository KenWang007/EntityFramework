...
namespace Microsoft.EntityFrameworkCore.Internal
{
        ...
        where TContext : DbContext
    {
        ...
        {
            _maxSize = options.FindExtension<CoreOptionsExtension>()?.MaxPoolSize ?? 32;
        ...
        public virtual TContext Rent([NotNull] IServiceProvider serviceProvider)
        {
            ...
            ((IDbContextPoolable)context).DbContextPool = this;
        ...
        public virtual void Dispose()
        {
            ...
            {
                ((IDbContextPoolable)context).DbContextPool = null;
                context.Dispose();
            }
        }
    }
